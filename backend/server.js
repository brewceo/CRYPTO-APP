...
// --- Routes ---
// API-prefixed routes used by the frontend.
// Auth routes: GET/POST /api/register, GET/POST /api/login, GET/POST /api/logout
...
// Root-level aliases match the assignment route names exactly.
app.use("/", authRoutes);
app.use("/", userRoutes);
